...
-- dev 시드 (성수 계열) — 반포 카탈로그 9종은 마이그레이션 0078이 소유 (unique(town,name) 멱등)
insert into routes (name, area, town, km, terrain, tags, features, checked_at) values
  ('서울숲 순환 코스', '성수동', '성수동', 5, '흙길 70%', '{중형견 최적,그늘 많음,식수대 2곳}',
   '[{"g":"❋","label":"공원"},{"g":"⏚","label":"흙길"},{"g":"♒","label":"식수대 2곳"},{"g":"☂","label":"그늘"}]', '2026-07-18'),
  ('뚝섬 리버뷰 코스', '뚝섬한강공원', '성수동', 5, '포장 60%', '{리버뷰,평지,야간 조명}',
   '[{"g":"♒","label":"리버뷰"},{"g":"—","label":"평지"},{"g":"☀","label":"야간 조명"}]', '2026-07-20'),
  ('서울숲 숲길 3km', '성수동', '성수동', 3, '흙길 90%', '{소형견·시니어,완만,조용함}',
   '[{"g":"❋","label":"숲길"},{"g":"⏚","label":"흙길 90%"}]', '2026-07-15'),
  ('뚝섬–잠원 7km', '한강', '성수동', 7, '포장 80%', '{고에너지견,장거리,한강 시리즈}',
