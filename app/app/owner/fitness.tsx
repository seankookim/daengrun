...
export default function FitnessHub() {
  ...
  // Loaders are useCallback'd (they close over setters only, so they are stable) so the focus effect
  // can list its real dependency without re-running on every render.
