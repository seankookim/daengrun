  ...
  return (
    <View style={s.root}>
      ...
      <View style={s.liveBar}>
        <Row style={{ justifyContent: 'space-between' }}>
          <Row style={{ gap: 10 }}>
            ...
            <View>
              ...
              <Text style={{ fontSize: 11, color: '#8fa093' }}>{dog.name}와 러닝 중</Text>
            </View>
          </Row>
        ...
        <View style={{ height: 1, backgroundColor: '#24352a', marginVertical: 14 }} />
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <View style={{ alignItems: 'center' }}>
      ...
      <Text style={{ fontSize: 10, color: '#8fa093', marginTop: 2 }}>{label}</Text>
    </View>
  );
}
