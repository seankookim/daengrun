...
function Barcode({ width = 118 }: { width?: number }) {
  return (
  ...
  return (
    <Row style={[styles.lr, total && { borderBottomWidth: 0 }]}>
      ...
      <Text style={styles.lrVal}>
        <Text style={[styles.lrValNum, nf, total && { fontSize: 16 }]}>{value}</Text>{unit}
      </Text>
    </Row>
  );
}
...
export default function RunnerHome() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: lilac.bg }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 12, paddingTop: 12, paddingBottom: 28 }}>
        ...
        <View style={styles.bib}>
          ...
          <Row style={{ justifyContent: 'space-between', alignItems: 'flex-start', paddingHorizontal: 20, paddingTop: 16, gap: 10 }}>
          ...
          <Row style={{ alignItems: 'flex-end', gap: 12, paddingHorizontal: 20, paddingTop: 8 }}>
            <View>
              <Text style={[styles.bibNo, nf]}>{String(stats.runs).padStart(2, '0')}</Text>
        ...
        <View style={[styles.card, { marginTop: 11, padding: 5 }]}>
          <View style={styles.ledgerIn}>
            ...
            <Row style={{ alignItems: 'flex-end', gap: 4, marginTop: 11 }}>
              <Text style={[styles.won, nf]}>₩</Text>
              <Text style={[styles.lBig, nf]}>{stats.net.toLocaleString()}</Text>
            </Row>
              ...
              <Row style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                <Row style={{ alignItems: 'center', gap: 6 }}>
                  <View style={{ width: 14, height: 14, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ width: 7, height: 7, borderRadius: 4, backgroundColor: lilac.coral }} />
                  </View>
                  <Text style={{ fontSize: 11.5, fontWeight: '800', color: STAGE[current.rawStatus]?.color ?? CORAL_INK }}>
        ...
        {inbox.length > 0 ? (
              ...
              <View style={styles.tMain}>
                ...
                <View style={{ paddingHorizontal: 13, paddingTop: 9, paddingBottom: 12 }}>
                  ...
                  <Row style={{ alignItems: 'center', gap: 6, marginTop: 8 }}>
                    <View style={{ width: 8, height: 10, borderRadius: 4, backgroundColor: lilac.coral }} />
              ...
              {inbox.slice(1).map((rq, i) => (
                <View key={i} style={styles.stub}>
                  ...
                  <View style={{ flex: 1, minWidth: 0, paddingHorizontal: 11, paddingTop: 12, paddingBottom: 10 }}>
                    ...
                    <Row style={{ alignItems: 'center', gap: 6, marginTop: 5 }}>
                      <Text style={styles.stubWhen}>{rq.when}</Text>
                    </Row>
                  </View>
                  <View style={styles.stubAct}>
                    <View style={[styles.stubNotch, { top: -6.5 }]} />
                    <View style={[styles.stubNotch, { bottom: -6.5 }]} />
          ...
          <View style={styles.emptyInbox}>
            <Text style={{ fontSize: 12, color: lilac.dim, textAlign: 'center' }}>
        ...
        <Pressable onPress={() => router.push('/runner/rewards')} style={styles.card}>
          {(() => {
            ...
            if (!t) {
              return <Text style={{ fontSize: 13, fontWeight: '800', color: lilac.head }}>🏅 마스터 러너 — 최저 수수료 15%</Text>;
            }
            ...
            return (
              <>
                <Row style={{ justifyContent: 'space-between', alignItems: 'baseline' }}>
                  <Text style={{ fontSize: 12.5, fontWeight: '700', color: lilac.head }}>
                ...
                <Text style={{ fontSize: 9.5, lineHeight: 14.5, color: lilac.dim, marginTop: 8 }}>
          ...
          <Row style={{ justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ fontSize: 12, fontWeight: '700', color: lilac.head }}>
          ...
          <Row style={{ alignItems: 'center', height: 52, marginTop: 6 }}>
            ...
            <View style={{ transform: [{ translateY: 12 }], width: 28, height: 28, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <Text style={{ fontSize: 11.5, fontWeight: '700', color: lilac.head, marginTop: 2 }}>
            {rs.totalRuns === 0
          ...
          <Row style={{ alignItems: 'center', gap: 8, marginTop: 9, paddingTop: 9, borderTopWidth: 1, borderTopColor: lilac.hair2 }}>
        ...
        <View style={styles.card}>
          {!avail ? (
            <Text style={{ fontSize: 13, color: lilac.dim }}>불러오는 중...</Text>
          ) : (
            <>
              <Row style={{ gap: 4 }}>
                {DAY_ORDER.map((wd) => {
              ...
              <Text style={{ fontSize: 9.5, lineHeight: 14.5, color: lilac.dim, marginTop: 9 }}>
...
const styles = StyleSheet.create({
  ...
  crumb: { fontSize: 8.5, letterSpacing: 2.4, color: lilac.dim, fontWeight: '600' },
  bell: {
    width: 28, height: 28, borderRadius: 6, borderWidth: 1, borderColor: lilac.hair,
  ...
  kickerTxt: { fontSize: 8, letterSpacing: 2.4, color: lilac.dim, fontWeight: '600' },

  srNo: { fontSize: 8.5, letterSpacing: 1.3, color: lilac.accent, fontWeight: '700' },
  srTitle: { fontSize: 12.5, fontWeight: '700', color: lilac.head },
  srLink: { fontSize: 9.5, color: lilac.dim, fontWeight: '500' },
  ...
  pin: {
    position: 'absolute', width: 7, height: 7, borderRadius: 4, backgroundColor: lilac.inset,
    borderWidth: 1, borderColor: lilac.hair, zIndex: 2,
  },
  bibOrg: { fontSize: 8, letterSpacing: 1.9, color: lilac.dim, fontWeight: '600', marginBottom: 5 },
  bibName: { fontSize: 30, color: lilac.head, lineHeight: 30 },
  ...
  swKnob: { width: 19, height: 19, borderRadius: 10, backgroundColor: '#fff', shadowColor: '#1C1837', shadowOpacity: 0.3, shadowRadius: 2, shadowOffset: { width: 0, height: 1 } },
  swLabel: { fontSize: 8, letterSpacing: 1.4, fontWeight: '700' },
  bibNo: { fontSize: 72, color: lilac.head, lineHeight: 62, letterSpacing: -1 },
  bibNoCap: { marginTop: 6, fontSize: 10, fontWeight: '600', color: lilac.text },
  ...
  bsK: { fontSize: 7.5, letterSpacing: 1.3, color: lilac.dim, fontWeight: '600' },
  bsV: { fontSize: 11, fontWeight: '600', color: lilac.head },
  bsVNum: { fontSize: 12.5, color: lilac.head },
  bibFoot: {
    marginTop: 13, borderTopWidth: 1.5, borderTopColor: '#DCD7F0', borderStyle: 'dashed',
    justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, backgroundColor: lilac.card,
  },
  bibFootTxt: { fontSize: 8.5, letterSpacing: 1.6, color: lilac.dim, fontWeight: '500' },
  ...
  lBrand: { fontSize: 8.5, letterSpacing: 1.7, color: lilac.head, fontWeight: '700' },
  monoTagV: { borderWidth: 1, borderColor: '#DCD6F8', backgroundColor: '#F4F1FE', borderRadius: lilacRadius.tag, paddingHorizontal: 6, paddingVertical: 3 },
  monoTagVTxt: { fontSize: 8, letterSpacing: 1.2, color: lilac.accent, fontWeight: '600' },
  monoTagStar: { borderWidth: 1, borderColor: lilac.amberEdge, backgroundColor: lilac.amberSoft, borderRadius: lilacRadius.tag, paddingHorizontal: 6, paddingVertical: 3 },
  monoTagStarTxt: { fontSize: 8, letterSpacing: 1, color: lilac.amber, fontWeight: '700' },
  won: { fontSize: 20, color: CORAL_INK, lineHeight: 22 },
  lBig: { fontSize: 44, color: lilac.head, lineHeight: 44, letterSpacing: 0.2 },
  lCap: { marginTop: 6, fontSize: 10, color: lilac.dim, lineHeight: 14.5 },
  lr: { alignItems: 'baseline', gap: 7, paddingTop: 7, paddingBottom: 6, borderBottomWidth: 1, borderBottomColor: lilac.hair2 },
  lrLabel: { fontSize: 10.5, fontWeight: '600', color: lilac.head },
  lrSub: { fontSize: 7, letterSpacing: 1.3, color: lilac.dim, fontWeight: '500', marginTop: 1 },
  lead: { flex: 1, borderBottomWidth: 1, borderStyle: 'dotted', borderBottomColor: '#D5CFEC', transform: [{ translateY: -3 }] },
  lrVal: { fontSize: 9.5, fontWeight: '500', color: lilac.text },
  ...
  lFootTxt: { fontSize: 9.5, color: lilac.dim, flex: 1 },
  lFootLink: { fontSize: 10, fontWeight: '700', color: lilac.accent },

  // 진행 중
  now: {
    backgroundColor: lilac.card, borderWidth: 1, borderColor: lilac.hair2, borderRadius: lilacRadius.card,
    overflow: 'hidden', paddingVertical: 12, paddingRight: 12, paddingLeft: 14, marginTop: 8,
    shadowColor: '#1C1837', shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 2,
  },
  nowEdge: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 3, backgroundColor: lilac.coral },
  nowWhen: { fontSize: 10, letterSpacing: 1.4, color: lilac.dim, fontWeight: '500' },
  nowTitle: { marginTop: 8, fontSize: 16, fontWeight: '700', color: lilac.head },
  nowSub: { marginTop: 3, fontSize: 10, color: lilac.dim },
  btnCoral: {
  ...
  btnQuietTxt: { fontSize: 12, fontWeight: '700', color: lilac.head },
  ...
  tBrand: { fontSize: 9, letterSpacing: 1.8, color: lilac.head, fontWeight: '700' },
  tBig: { fontSize: 30, color: lilac.head, lineHeight: 32 },
  tWhere: { fontSize: 13.5, fontWeight: '600', color: lilac.head },
  tWhereSub: { fontSize: 10, color: lilac.dim },
  factK: { fontSize: 8, letterSpacing: 1.4, color: lilac.dim, fontWeight: '600', marginBottom: 3 },
  factV: { fontSize: 12, fontWeight: '600', color: lilac.head },
  factVNum: { fontSize: 14, color: lilac.head },
  factVUnit: { fontSize: 9.5, fontWeight: '500', color: lilac.text },
  ...
  doorName: { fontSize: 14.5, fontWeight: '800' },
  doorSub: { marginTop: 4, fontSize: 9 },
  ...
  stubNm: { fontSize: 13.5, fontWeight: '700', color: lilac.head },
  stubKm: { fontSize: 13, fontWeight: '600', color: lilac.head },
  stubKmUnit: { fontSize: 9, color: CORAL_INK, fontWeight: '600' },
  stubWhen: { fontSize: 11, color: lilac.dim, fontWeight: '500' },
  stubAct: { width: 100, borderLeftWidth: 1.4, borderStyle: 'dashed', borderLeftColor: '#DCD7F0', paddingVertical: 11, paddingHorizontal: 8, alignItems: 'center', justifyContent: 'center', gap: 7 },
  stubNotch: { position: 'absolute', left: -6.7, width: 12, height: 12, borderRadius: 6, backgroundColor: lilac.bg, borderWidth: 1, borderColor: lilac.hair2, zIndex: 3 },
  stubFare: { fontSize: 17, color: lilac.head },
  stubFareCap: { fontSize: 7, letterSpacing: 1.3, color: lilac.dim, fontWeight: '500', marginTop: 3 },
  ...
  stubMore: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 8, borderWidth: 1, borderStyle: 'dashed', borderColor: lilac.hair, borderRadius: lilacRadius.card, paddingVertical: 10, paddingHorizontal: 11, backgroundColor: lilac.glass },
  stubMoreTxt: { fontSize: 10, color: lilac.text, flex: 1 },
  stubMoreLink: { fontSize: 9.5, fontWeight: '700', color: lilac.accent },
  emptyInbox: { marginTop: 9, backgroundColor: lilac.inset, borderRadius: lilacRadius.card, padding: 14, borderWidth: 1, borderColor: lilac.hair },

  // ② 루트
  stop: { flexDirection: 'row', alignItems: 'flex-start', gap: 11, paddingVertical: 8 },
  ...
  stopTm: { fontSize: 14, fontWeight: '600', color: lilac.head },
  stopTmSub: { fontSize: 8.5, color: lilac.dim, fontWeight: '500', marginTop: 2 },
  stopInfoB: { fontSize: 12, fontWeight: '600', color: lilac.head },
  stopInfoS: { fontSize: 9.5, color: lilac.dim, marginTop: 2 },
  stopPay: { fontSize: 12.5, fontWeight: '600', color: lilac.head, marginTop: 1 },

  // ③ 리워드
  fee: { fontSize: 10, letterSpacing: 0.6, color: lilac.head, fontWeight: '600' },
  ...
  trailCnt: { fontSize: 9, letterSpacing: 0.8, color: lilac.accent, fontWeight: '500' },
  flagLb: { fontSize: 8, letterSpacing: 1.4, color: lilac.dim, fontWeight: '600' },
  ...
  flagCnt: { fontSize: 10, fontWeight: '600', color: lilac.head },
  ...
  dayD: { fontSize: 13, fontWeight: '700', lineHeight: 14 },
  dayH: { fontSize: 8, letterSpacing: 0.4, fontWeight: '500', marginTop: 4 },
  ...
  patchFallbackTxt: { fontSize: 11, color: '#CFC4FF', fontWeight: '600' },
  drowB: { fontSize: 11.5, fontWeight: '600', color: lilac.head },
  drowS: { fontSize: 9, color: lilac.dim, marginTop: 2 },
  drowPay: { fontSize: 12, fontWeight: '600', color: lilac.text },
  ...
  shotTxt: { fontSize: 8.5, fontWeight: '600', color: lilac.head },

  // 퀵 링크 + 푸터
  qlink: { flexBasis: '48.5%', flexGrow: 1, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 6, backgroundColor: lilac.glass, borderWidth: 1, borderStyle: 'dashed', borderColor: lilac.hair, borderRadius: lilacRadius.card, paddingVertical: 10, paddingHorizontal: 11 },
  qlinkB: { fontSize: 10.5, fontWeight: '600', color: lilac.head },
  qlinkChev: { fontSize: 10, color: lilac.dim },
  foot: { alignItems: 'center', gap: 6, paddingTop: 10, marginTop: 12, borderTopWidth: 1, borderTopColor: lilac.hair },
  footTxt: { fontSize: 9, letterSpacing: 0.2, color: lilac.dim },
