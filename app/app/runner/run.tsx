          ...
          {targetKm != null && remaining != null ? (
            <>
              <Row style={{ justifyContent: 'space-between', marginBottom: 8 }}>
                {/* merge: trunk's honest km label (bookingKmLabel, post-sweep-base) + the sweep's 15pt floor */}
                <Text style={{ fontSize: 15, color: paper.dim }}>{info?.routeName} 코스 · {bookingKmLabel(targetKm)}</Text>
