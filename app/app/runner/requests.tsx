      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 22, paddingTop: 60, paddingBottom: 30 }}>
        <Row style={{ justifyContent: 'space-between' }}>
          <View>
            ...
            <Text style={{ fontSize: 12, color: colors.dim, marginTop: 3 }}>새 요청 {runRequests.length}건 · 응답률 98%</Text>
          </View>
          <View style={s.autoPill}>
            <Text style={{ fontSize: 11, fontWeight: '700', color: '#3d453d' }}>자동 수락 꺼짐</Text>
          </View>
        </Row>
