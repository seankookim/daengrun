...
const s = StyleSheet.create({
  ...
  amtUnit: { fontSize: 15, fontWeight: '700', color: paper.dim },
  status: { fontSize: 15, fontWeight: '800', color: paper.dim, marginTop: 2 },
  banner: {
  ...
  bannerBody: { fontSize: 15, lineHeight: 20, fontWeight: '700', color: paper.text, marginTop: 4 },
  bannerDetail: { fontSize: 15, lineHeight: 18, color: paper.critical, marginTop: 4 },
