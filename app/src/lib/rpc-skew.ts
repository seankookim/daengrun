...
export const PENDING_DEPLOY: Record<string, string> = {
  ...
  // ⚠ 배포하는 순간 이 줄을 지우고 아래 테스트의 목록 핀도 같이 고칠 것. 0143은 이 커밋과 함께
  //   작성됐고, 스택이 배포되기 전까지 프로덕션에 없다 — 그 창을 한국어로 정직하게 실패시키려고
  //   여기 있다. (0134 줄과 같은 규율: 목록은 늘어나는 게 아니라 줄어야 한다.)
  session_record_companion_run: '0143 — 동반 러닝 기록 writer, 배포 전 (2026-08-27 작성)',
};
