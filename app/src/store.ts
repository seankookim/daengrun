...
// 진실 패스 (2026-08-05, brand-deals office hours 결정 B): 실존 브랜드 콜라보 표기 전량 은퇴.
// 바잇미·페스룸·페티즌은 b2b-revenue.md의 '미접촉 후보'였는데 앱이 체결된 콜라보처럼 그리고 있었다 —
// 실계약 없는 실브랜드 표기는 정직 원칙 위반이자 아웃리치 지뢰. 콜라보 라인은 계약 체결 시에만 부활.
export const products: Product[] = [
  { id: 'leash', collab: '도그스하이 에디션', name: '야간 반사 러닝 전용 리드줄', price: 24000, tag: '리드줄', colors: ['#ffd9cc', '#ff8f6e'], fg: '#8f2b0e' },
  { id: 'treat', collab: '도그스하이 에디션', name: '동결건조 북어 트릿 80g', price: 12900, tag: '간식', colors: ['#f3e6bd', '#dcc26a'], fg: '#7a651f' },
  { id: 'vest', collab: '도그스하이 에디션', name: '여름 러닝 쿨링 조끼', price: 19800, tag: '쿨링', colors: ['#c9e4f2', '#7db8d6'], fg: '#1f5a7a' },
  { id: 'vitamin', collab: '도그스하이 에디션', name: '관절 케어 츄어블 60정', price: 29000, tag: '영양제', colors: ['#dcd2f0', '#a390d4'], fg: '#463175' },
  { id: 'led', collab: '도그스하이 에디션', name: '야간 러닝 LED 목걸이', price: 15500, tag: 'LED', colors: ['#d4ecc3', '#93c46e'], fg: '#3d6b1e' },
  { id: 'bottle', collab: '도그스하이 에디션', name: '원핸드 러닝 물병 350ml', price: 13000, tag: '물병', colors: ['#f2d9c9', '#d8a077'], fg: '#7a4a22' },
];

// ---------- Community ----------
// posts 목업 은퇴 (2026-08-05, 진실 패스): community.tsx는 feed_posts 실데이터를 쓰고 이 배열은 소비자 0.
// p4는 실브랜드(페스룸) 제품에 붙은 사전 작성 뒷광고 문안이었다 — 표시광고법·정직 원칙 정면 위반이라 사체째 삭제.
