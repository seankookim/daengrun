...
- [ ] **Sean: `npx supabase db push` (0025 패치 보너스 + 0026 반복 예약)** — 함수 재배포는 불필요 (RPC/크론만)
...
- [ ] **샵 셸**: 하이 포인트 사용처. gear_claims 교환권 연동 · 드랍 카드 · 부스트. shop.tsx 셸 존재
- [ ] fetchMiles/fetchLedgerTotal 2000행 상한 → 서버 집계 RPC
