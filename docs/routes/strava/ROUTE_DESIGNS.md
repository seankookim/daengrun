...
1. 석촌호수 from a same-side residential anchor, targeting 3–4.5 km and using surface approaches.
2. 올림픽공원 from a nearby residential gate, targeting 3–4.5 km entirely within surface-accessible
   park approaches.
3. 양재천 from 도곡동, using separate stream tiers for outbound and return legs.
4. 서울숲 from 성수동, avoiding the time-restricted 보행가교 and keeping the route inland.
