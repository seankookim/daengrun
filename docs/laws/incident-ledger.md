# Incident ledger — the stories behind the laws

Companion to `docs/laws/CLAUDE-slim-draft.md` (option A of
`docs/decisions/2026-09-15-harness-diet-proposal.md`). **Every paragraph below is moved
VERBATIM from `CLAUDE.md` as it stood at 100,220 bytes on 2026-09-15** — cut and pasted, not
rewritten and not summarised, because the measurements in them were paid for once and must
not be re-learned. Each `§n` heading names the law the story supports and the date it was
measured; the slim file points here by that number. Line numbers cited are from the
original CLAUDE.md.

Nothing here is a new instruction. If a story and the slim file ever disagree, the slim
file is the law and this is the evidence.

---

## §1 — Language — English everywhere except in-app content (2026-08-08)

*CLAUDE.md lines 13–14, verbatim.*
...
## §2 — Verify a push by reading the artifact back from origin; a detector whose success pattern is a substring of its failure output (2026-08-25)

*CLAUDE.md lines 27–38, verbatim.*
...
## §3 — A codex run is done when a verdict is in the file — not on exit status, never on log size (2026-08-26)

*CLAUDE.md lines 71–93, verbatim.*
...
## §4 — The verdict-grep's third disguise — the prompt echo puts `VERDICT:` in the log (2026-08-26)

*CLAUDE.md lines 95–116, verbatim.*
...
## §5 — v3 — the value-match is defeated if the prompt enumerates the values; split the streams (2026-08-27)

*CLAUDE.md lines 118–143, verbatim.*
...
## §6 — The general form — every token you put in the prompt is unsafe to grep for (2026-08-26)

*CLAUDE.md lines 145–178, verbatim.*
...
## §7 — Do not say a slice is under codex review until a verdict exists; why codex is a gate (2026-08-26)

*CLAUDE.md lines 180–192, verbatim.*
...
## §8 — A run that never started looks exactly like a run still working — enumerate the failure states (2026-08-27)

*CLAUDE.md lines 194–217, verbatim.*
...
## §9 — The verdict detector, final form: ask for a digit (`FINDINGS: <n>`) (2026-08-27)

*CLAUDE.md lines 219–233, verbatim.*
...
## §10 — Treating a finding as narrower than its own sentence (2026-08-27)

*CLAUDE.md lines 235–251, verbatim.*
...
## §11 — A pin that inherits another pin's setup is testing the setup (2026-08-27)

*CLAUDE.md lines 253–259, verbatim.*
...
## §12 — A control that reads the same variable through the same operator is not a second measurement (2026-08-27)

*CLAUDE.md lines 261–273, verbatim.*
...
## §13 — NULL collapses every `IF`-based pin into silence — use `is distinct from` / `is not true` (2026-08-27)

*CLAUDE.md lines 275–292, verbatim.*
...
## §14 — Why the comment-matching class is structural — `prosrc` is source plus our own prose (2026-08-27)

*CLAUDE.md lines 294–304, verbatim.*
...
## §15 — A source pin that matches prose is measuring the documentation — strip comments before matching (2026-08-27)

*CLAUDE.md lines 306–315, verbatim.*
...
## §16 — A pin whose fixture cannot distinguish two rules is testing the fixture (2026-08-27)

*CLAUDE.md lines 317–325, verbatim.*
...
## §17 — A pin that reversed is not a pin that was weak (2026-08-27)

*CLAUDE.md lines 327–332, verbatim.*
...
## §18 — Mutate the guard's PRECONDITION, not only what the guard does (2026-08-27)

*CLAUDE.md lines 334–351, verbatim.*
...
## §19 — A mutation that reddens nothing has two very different causes — name which (2026-08-27)

*CLAUDE.md lines 353–368, verbatim.*
...
## §20 — Pin labels collide the same way migration numbers do — prefix by slice (2026-08-27)

*CLAUDE.md lines 370–376, verbatim.*
...
## §21 — A guard with no pin is invisible from both directions — the only detector is deleting it (2026-08-27)

*CLAUDE.md lines 378–388, verbatim.*
...
## §22 — A handoff that says 「this pin should be failing」 manufactures a false green in documentation (2026-08-27)

*CLAUDE.md lines 390–399, verbatim.*
...
## §23 — The stranded-work sweep's evidence-strength trap (2026-08-27)

*CLAUDE.md lines 401–408, verbatim.*
...
## §24 — A measurement's write-up outlives the thing measured — re-run after the LAST edit (2026-08-27)

*CLAUDE.md lines 410–417, verbatim.*
...
## §25 — Before paying to measure an unknown, check whether it is load-bearing (the kst.ts convergence) (2026-08-27)

*CLAUDE.md lines 419–436, verbatim.*
...
## §26 — A `try`/`catch` fallback that renders different words is two products (2026-08-27)

*CLAUDE.md lines 438–445, verbatim.*
...
## §27 — A gate with a false negative is strictly worse than no gate (2026-08-27)

*CLAUDE.md lines 447–457, verbatim.*
...
## §28 — Do not write a pin to document a limitation — a limitation is prose (2026-08-27)

*CLAUDE.md lines 458–470, verbatim.*
...
## §29 — A fixture that omits the defect cannot test the fix (2026-08-27)

*CLAUDE.md lines 472–483, verbatim.*
...
## §30 — A battery whose control fails measures nothing (stale postmasters) (2026-08-27)

*CLAUDE.md lines 485–493, verbatim.*
...
## §31 — A grant is not a door — check reachability before calling something exposed (2026-08-27)

*CLAUDE.md lines 495–518, verbatim.*
...
## §32 — The number that flatters your finding is the one you don't audit (the 412 dim-text count) (2026-08-27)

*CLAUDE.md lines 520–548, verbatim.*
...
## §33 — The noise filter is the most dangerous part of a sweep; the standing rule for a new detector (2026-08-27)

*CLAUDE.md lines 550–570, verbatim.*
...
## §34 — A timezone bug is invisible to a UTC-only test arm (2026-08-27)

*CLAUDE.md lines 572–594, verbatim.*
...
## §35 — The migration-number check is three-sided, and re-read at COMMIT time (2026-08-27)

*CLAUDE.md lines 596–606, verbatim.*
...
## §36 — Three ways a green means nothing — manifest, dead battery, unobserved control; plus a widened SQL return (2026-08-27)

*CLAUDE.md lines 608–640, verbatim.*
...
## §37 — Never read a test result through `tail` (2026-08-26)

*CLAUDE.md lines 644–661, verbatim.*
...
## §38 — `check-device-clock.mjs` — why it exists, its two load-bearing narrowings, its false negative (2026-08-27)

*CLAUDE.md lines 669–706, verbatim.*
...
## §39 — `check-definer-acl.mjs` — why the narrowness is the feature (147 vs 82) (2026-08-25)

*CLAUDE.md lines 708–725, verbatim.*
...
## §40 — `check-route-native-imports.mjs` — a dev-only screen can crash a production launch (2026-08-13)

*CLAUDE.md lines 727–735, verbatim.*
...
## §41 — Branches — why `main` was deleted and why worktrees are cut from `origin/redesign-v4` (2026-08-13)

*CLAUDE.md lines 739–765, verbatim.*
...
## §42 — A reviewer must attack INACTION, not only transitions (2026-08-25)

*CLAUDE.md lines 769–779, verbatim.*
...
## §43 — A comment that quotes the code it replaced; a column name is a substring; the trigger ladder and `tgenabled` (2026-08-26)

*CLAUDE.md lines 781–853, verbatim.*
...
## §44 — What the database shows is not what the product means (count(*) = 11) (2026-08-26)

*CLAUDE.md lines 854–862, verbatim.*
...
## §45 — A hedge does not make a load-bearing premise safe (2026-08-26)

*CLAUDE.md lines 863–880, verbatim.*
...
## §46 — A green light is evidence for exactly one sentence (2026-08-25)

*CLAUDE.md lines 882–890, verbatim.*
...
## §47 — The mutation discipline — three propositions; `sed` exits 0 when it matches nothing (2026-08-26)

*CLAUDE.md lines 891–904, verbatim.*
...
## §48 — A pin added mid-battery; and the assertion must GATE the run, not merely precede it (2026-08-27)

*CLAUDE.md lines 905–936, verbatim.*
...
## §49 — A `create or replace` that relies on grant preservation is a latent PUBLIC-EXECUTE hole (2026-08-25)

*CLAUDE.md lines 939–940, verbatim.*
...
## §50 — Migration numbers come from the remote tip; two-sided; the pre-push hook and `core.hooksPath` (2026-08-13)

*CLAUDE.md lines 943–966, verbatim.*
...
## §51 — A suite whose pinned behaviour legitimately changes must be updated in the same slice (2026-08-13)

*CLAUDE.md lines 967–972, verbatim.*
...
## §52 — A relayed decision is evidence, not authority — and a relayed ANALYSIS carries the same duty (2026-08-25)

*CLAUDE.md lines 973–998, verbatim.*
...
## §53 — The detail-text floor drifted twice in this extract (14 vs 15; the club world) (2026-08-31)

*CLAUDE.md lines 1006–1024, verbatim.*
...
## §54 — Owner-home's hero was removed from the DO-NOT-REFACTOR freeze (2026-08-19)

*CLAUDE.md lines 1034–1034, verbatim.*
...
## §55 — Ship means push — the line that sat stale for eleven days (2026-08-21)

*CLAUDE.md lines 1042–1042, verbatim.*
...
## §56 — A rebase can commit conflict markers silently; a number collision has the same only-fix (2026-08-26)

*CLAUDE.md lines 1079–1108, verbatim.*
...
## §57 — `git add … && git commit` is unsafe while another agent can write your tree — use a pathspec (2026-08-25)

*CLAUDE.md lines 1110–1178, verbatim.*
